...
namespace Modules\TestManage\Http\PageBuilder\Addons;
...
class TestAddon extends PageBuilderBase
{
    ...
    {
        return externalAddonImagepath('TestManage');
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('about_story', $data, 'TestManage');
    }
    ...
    {
        return __("Test Addon for TestManage");
    }
}
